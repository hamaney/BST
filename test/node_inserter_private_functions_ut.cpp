...
TEST_F(NodeInserterFunctionsCollection, InsertUniqueEntriesToTheTree) {
  ...
  */
  ...
  ASSERT_TRUE(
      tree.Insert_(tree.root, 2));  // return the parentwich is node contain 4
  ...
  ASSERT_TRUE(tree.Insert_(tree.root, 6));
  ...
  ASSERT_TRUE(tree.Insert_(tree.root, 1));
  ...
  ASSERT_TRUE(tree.Insert_(tree.root, 3));
  ...
  ASSERT_TRUE(tree.Insert_(tree.root, 5));
  ...
  ASSERT_TRUE(tree.Insert_(tree.root, 7));
...
TEST_F(NodeInserterFunctionsCollection, InsertAnExistingEntryToTheTree) {
  ...
  ASSERT_FALSE(tree.Insert_(tree.root, 6));
  ASSERT_FALSE(tree.Insert_(tree.root, 7));
}
