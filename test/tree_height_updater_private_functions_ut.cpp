...
TEST_F(TreeHeightUpdaterFunctionCollection, NodeHeightUpdatingNonRecursively) {
  ...
  */
  ...
  //  [1(0)]  [3(0)][5(99)]
  */
  tree.UpdateHeightOfNodeNonRecursively_(tree.Find(6));
  /*        ____[4(2)]____
  //       /              \
  //     _[2(1)]_      _[6(100)]
  //    /        \    /
  ...
  */
  ...
  //  [1(88)]  [3(77)][5(99)]
  */
  tree.UpdateHeightOfNodeNonRecursively_(tree.Find(2));
  /*        ____[4(2)]____
  //       /              \
  //     _[2(89)]_      _[6(1)]
  //    /          \    /
  ...
  */
  ...
  /*         ____[4(2)]_____
   ...
   //  [1(33)]   [3(44)][5(99)]
   */
  tree.UpdateHeightOfNodeNonRecursively_(tree.Find(4));
  /*         ____[4(101)]_____
   //       /                 \
   //     _[2(89)]_       _[6(100)]
   //    /          \    /
...
TEST_F(TreeHeightUpdaterFunctionCollection, ReadNodeHeightNonRecursively) {
  ...
  */
  ASSERT_EQ(
      tree.CalculateNodeHeightNonRecursivelyAndWithoutUpdatingTheNode_(tree.Find(1)),
      0);
  ASSERT_EQ(
      tree.CalculateNodeHeightNonRecursivelyAndWithoutUpdatingTheNode_(tree.Find(2)),
      45);
  ASSERT_EQ(
      tree.CalculateNodeHeightNonRecursivelyAndWithoutUpdatingTheNode_(tree.Find(3)),
      0);
  ASSERT_EQ(
      tree.CalculateNodeHeightNonRecursivelyAndWithoutUpdatingTheNode_(tree.Find(5)),
      0);
  ASSERT_EQ(
      tree.CalculateNodeHeightNonRecursivelyAndWithoutUpdatingTheNode_(tree.Find(6)),
      100);
  ASSERT_EQ(
      tree.CalculateNodeHeightNonRecursivelyAndWithoutUpdatingTheNode_(tree.Find(4)),
      112);
}
TEST_F(TreeHeightUpdaterFunctionCollection,
  ...
  */
  ...
  //  [1(77)]  [3(66)] [5(55)]
  */
  tree.UpdateHeightOfNodeRecursively_(tree.Find(4));
  /*        ____[4(2)]_____
  //       /               \
  //     _[2(1)]_       _[6(1)]
  //    /        \     /
...
TEST_F(TreeHeightUpdaterFunctionCollection, NodeParentHeightUpdating) {
  ...
  */
  ...
  //                 [6(0)]
  */
  tree.UpdateTheParentsStartingFromParent_(tree.Find(2));
  /*        ____[4(79)]____
  //       /               \
  //     _[2(78)]_       _[7(2)]
  //    /         \     /
  ...
  */
  ...
  tree.UpdateTheParentsStartingFromParent_(tree.Find(5));
  /*        ____[4(79)]____
  //       /               \
  //     _[2(78)]_       _[7(57)]
  //    /         \     /
...
TEST_F(TreeHeightUpdaterFunctionCollection, UpdateHeightTheInterfaceFunction) {
  ...
  //                 [6(0)]
  */
  tree.UpdateHeight_(tree.Find(2));
  /*        ____[4(79)]____
  //       /               \
  //     _[2(78)]_       _[7(2)]
  //    /         \     /
  ...
  */
  ASSERT_EQ(tree.Find(5)->height, 1);
  tree.UpdateHeight_(tree.Find(5));
  /*        ____[4(79)]____
  //       /               \
  //     _[2(78)]_       _[7(57)]
  //    /         \     /
...
TEST_F(TreeHeightUpdaterFunctionCollection, UpdateHeightAfterRotation) {
  ...
  */
  ...
  tree.UpdateHeight_(latest_updated_node);
  /*      _[2(3)]_
  //     /        \
  //  [1(0)]      [3(2)]_
  //                     \
